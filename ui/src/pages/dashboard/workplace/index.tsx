  ...
  render() {
    ...
    return (
      ...
      <Modal title="新建记录" visible={visible} onOk={this.handleOk} onCancel={this.handleCancel}>
          <Form >
            <FormItem label="名称" name='name' rules={[{required:true}]}><Input /> </FormItem>
            <FormItem label="描述" name='desc' rules={[{required:true}]}><Input /> </FormItem>
            <FormItem label="链接" name='url'  rules={[{required:true}]}><Input /> </FormItem>
          </Form>
      </Modal>
