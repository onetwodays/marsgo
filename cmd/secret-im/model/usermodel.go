...
func (m *defaultUserModel) Insert(data User) (sql.Result, error) {
	...
	ret, err := m.conn.Exec(query, data.Name, data.Mobile, data.Password, data.Gender, data.Nickname)
	return ret, err
}
...
func (m *defaultUserModel) Update(data User) error {
	...
	_, err := m.conn.Exec(query, data.Name, data.Mobile, data.Password, data.Gender, data.Nickname, data.Id)
	return err
}
