...
var file_hello_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x67, 0x22, 0x32, 0x0a, 0x06, 0x61, 0x64, 0x64, 0x52, 0x65, 0x71, 0x12, 0x12, 0x0a,
	...
	0x6f, 0x6b, 0x32, 0x56, 0x0a, 0x05, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x27, 0x0a, 0x04, 0x50,
	0x69, 0x6e, 0x67, 0x12, 0x0e, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x24, 0x0a, 0x03, 0x61, 0x64, 0x64, 0x12, 0x0d, 0x2e, 0x68, 0x65,
	0x6c, 0x6c, 0x6f, 0x2e, 0x61, 0x64, 0x64, 0x52, 0x65, 0x71, 0x1a, 0x0e, 0x2e, 0x68, 0x65, 0x6c,
	0x6c, 0x6f, 0x2e, 0x61, 0x64, 0x64, 0x52, 0x65, 0x73, 0x70, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_hello_proto_goTypes = []interface{}{
	...
	(*AddReq)(nil),   // 2: hello.addReq
	(*AddResp)(nil),  // 3: hello.addResp
}
var file_hello_proto_depIdxs = []int32{
	0, // 0: hello.Hello.Ping:input_type -> hello.Request
	2, // 1: hello.Hello.add:input_type -> hello.addReq
	1, // 2: hello.Hello.Ping:output_type -> hello.Response
	3, // 3: hello.Hello.add:output_type -> hello.addResp
...
func (c *helloClient) Add(ctx context.Context, in *AddReq, opts ...grpc.CallOption) (*AddResp, error) {
	out := new(AddResp)
	err := c.cc.Invoke(ctx, "/hello.Hello/add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedHelloServer) Add(context.Context, *AddReq) (*AddResp, error) {
...
func _Hello_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello.Hello/Add",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServer).Add(ctx, req.(*AddReq))
	}
	return interceptor(ctx, in, info, handler)
}
